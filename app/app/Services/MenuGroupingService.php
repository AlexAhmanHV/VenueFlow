...
class MenuGroupingService
{
    public function groupItems(Collection $menuItems): array
    {
    ...
    public function isDrink(MenuItem $item): bool
    {
        ...
        return $this->normalizedTags($item)->intersect($drinkTags)->isNotEmpty();
    }
